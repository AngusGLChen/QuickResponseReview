...
def crawl_article_links(data_path):
    ...
    links = {1995:['https://dl.acm.org/citation.cfm?id=222020&picked=prox'],
             1997:['https://dl.acm.org/citation.cfm?id=1599773&picked=prox'],
             1999:['https://dl.acm.org/citation.cfm?id=1150240&picked=prox'],
             2002:['https://dl.acm.org/citation.cfm?id=1658616&picked=prox'],
             2005:['https://dl.acm.org/citation.cfm?id=1149293&picked=prox'],
             2007:['https://dl.acm.org/citation.cfm?id=1599600&picked=prox'],
             2009:['https://dl.acm.org/citation.cfm?id=1600053&picked=prox',
                   'https://dl.acm.org/citation.cfm?id=1599503&picked=prox']
             }
...
def crawl_article_metadata(data_path):
    ...
    # Iterate over years
    for year in [1995, 1997, 1999, 2002, 2005, 2007, 2009]:
        year = str(year)
...
def crawl_article_pdfUrls(data_path):
    ...
    for year in [1995, 1997, 1999, 2002, 2005, 2007, 2009]:
        year = str(year)
        # Initialize selenium
        download_dir = '/Users/gche0022/Downloads/Projects/QuickResponseReview/data/CSCL/' + year + '/'
