...
def crawl_article_links(data_path):
    ...
    links = {2011:'https://dl.acm.org/citation.cfm?id=2090116&picked=prox',
             2012:'https://dl.acm.org/citation.cfm?id=2330601&picked=prox',
             2013:'https://dl.acm.org/citation.cfm?id=2460296&picked=prox',
             2014:'https://dl.acm.org/citation.cfm?id=2567574&picked=prox',
             2015:'https://dl.acm.org/citation.cfm?id=2723576&picked=prox',
             2016:'https://dl.acm.org/citation.cfm?id=2883851&picked=prox',
             2017:'https://dl.acm.org/citation.cfm?id=3027385&picked=prox',
             2018:'https://dl.acm.org/citation.cfm?id=3170358&picked=prox',
             2019:'https://dl.acm.org/citation.cfm?id=3303772&picked=prox'
             }
...
def crawl_article_pdfUrls(data_path):
    ...
    for year in os.listdir(data_path):
        if year != '.DS_Store':
            # Initialize selenium
            download_dir = '/Users/gche0022/Downloads/Projects/QuickResponseReview/data/LAK/' + year + '/'
